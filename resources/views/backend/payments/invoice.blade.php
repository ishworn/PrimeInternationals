...
<div class="page-content">
            ...
            <div class="max-w-4xl mx-auto bg-gray-100 p-6 rounded-xl shadow-md">
                ...
                <div id="itemsContainer">
                    <div class="flex gap-4 mb-4 item-row">
                        ...
                        <input type="number" name="quantity[]" placeholder="Quantity" class="w-2/6 px-4 py-2 border rounded" />
                        <input type="number" name="rate[]" placeholder="Rate" class="w-2/6 px-4 py-2 border rounded rate-input" />
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-2 items-center">
                        <input type="number" name="discount" id="discount" placeholder="Enter discount" class="w-2/4 px-4 py-2 border rounded" />
                        <select name="discount_type" id="discount_type" class="w-1/4 px-2 py-2 border rounded">
        ...
        <div class="max-w-4xl mx-auto bg-white border border-gray-500 p-6 sm:p-10 shadow-md ">
            ...
            <div class="mt-8 overflow-x-auto">
                <table class="w-full text-left  min-w-[600px]">
                    ...
                    <tfoot id="invoiceTotal" class=" text-sm">
                ...
                .then(data => {
                    if (data.success) {
                        if (data.pdf_url) {
                            ...
                            //printInvoice(); // Optionally print
                        }

                        // Slight delay before triggering print to avoid conflict
                        setTimeout(() => {
                            printInvoice();
                        }, 500);
                    } else {
    ...
    <tr>
        ...
        <td class="py-3 px-2 text-right">Subtotal</td>
    ...
    `;
            ...
            <tr>
                <td></td>
                <td></td>
                <td class="py-3 px-2 text-right">Discount (${discountType === 'percent' ? discountValue +'%' : 'Rs. ' + discountValue.toFixed(2)  })</td>
                <td class="py-3 px-2 text-right">- Rs.${discountAmount.toFixed(2)}</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td class="py-3 px-2 text-right font-bold">Total</td>
                <td class="py-3 px-2 text-right font-bold">Rs.${finalTotal.toFixed(2)}</td>
            </tr>
        `;
            } else {
                invoiceTotal.innerHTML += `
            <tr>
                ...
                <td></td>
                <td class="py-3 px-2 text-right font-bold">Total</td>
                <td class="py-3 px-2 text-right font-bold">Rs.${total.toFixed(2)}</td>
            </tr>
        `;
            }
        }
