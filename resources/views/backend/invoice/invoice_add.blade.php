                        ...
                        <div class="row">
                            <div class="col-md-1">
                                <div class="md-3">
                                    ...
                                    <input class="form-control example-date-input" name="invoice_no" value="{{ $invoice_no }}" readonly style="background-color: #ddd">
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="md-3">
                                    ...
                                    <input class="form-control example-date-input" name="current_stock_qty" id="current_stock_qty" readonly style="background-color: #ddd">
                                </div>
                            </div>
                                ...
                                {{--Hide Add Customer Form--}}
                                    <div class="row new_customer" style="display: none">
                                        <div class="form-group col-md-4">
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Write your customer Name">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Write your customer Mobile Number">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input type="email" name="email" id="email" class="form-control" placeholder="Write your Email Name">
                                        </div>
