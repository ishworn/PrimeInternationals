...
<div class="content p-6 max-w-7xl mx-auto">
    <header>
        <h2 class="mb-6 text-3xl font-bold text-orange-600 border-b-4 border-orange-400 pb-3 uppercase tracking-wide">
            Vendor Dashboard
        </h2>
    </header>

    <h4 class="mb-8 text-gray-700 text-lg">Welcome, <span class="font-semibold">{{ auth()->user()->name }}</span>. Here's an overview of your vendor stats.</h4>
